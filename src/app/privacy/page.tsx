...
export default async function PrivacyPage() {
  const [settings, page] = await Promise.all([getSiteSettings(), getLegalPage("privacy")]);
  ...
  return (
    <div className="min-h-screen bg-caffeine-cream px-6 py-16 sm:py-24">
      ...
      <div className="max-w-2xl mx-auto prose prose-stone">
        ...
        <h1 className="font-cozy text-3xl font-bold text-caffeine-dark mt-6 mb-4">{page?.title || "Privacy Policy"}</h1>
